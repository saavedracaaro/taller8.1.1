...
fetch(DATA_URL)
  ...
  .then(data => {
    ...
    const students = data.students; // Para ingresar al array de estudiantes desde el JSON
    showData(students); // para llamar a la función showData con el array de estudiantes
  })
  .catch(error => {
